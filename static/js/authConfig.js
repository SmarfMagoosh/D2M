...
const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://d2m.gcc.edu/signin-oidc',//'http://localhost/signin-oidc', // You must register this URI on Azure Portal/App Registration. Defaults to window.location.href e.g. http://localhost:3000/
